      ...
      <section className="w-full max-w-4xl mx-auto flex flex-col items-center text-center space-y-10 pt-24 pb-10 px-6 relative z-10">
        ...
        >
          ...
          <h1 
            ...
            style={{ 
              textShadow: '0 4px 20px rgba(0,0,0,0.5), 0 0 40px rgba(255,255,255,0.4), 0 0 60px rgba(255,255,255,0.2)' 
            }}
          >
            {t('home_hero_title')}
          </h1>
          ...
          <motion.h2
            ...
            style={{ 
              textShadow: '0 2px 15px rgba(0,0,0,0.4), 0 0 30px rgba(255,255,255,0.3)' 
            }}
          >
