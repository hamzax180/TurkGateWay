        ...
        <div className="w-full relative px-6 md:px-16 pt-10 pb-16 flex flex-col lg:flex-row gap-12 max-w-[1400px] mx-auto">
          ...
          <article className="flex-1 max-w-4xl space-y-32 pb-32">
            ...
            <section id="smart-router" className="scroll-mt-24">
              <h2 className="text-3xl font-bold mb-10 flex items-center gap-4 border-b border-[var(--border)] pb-6">
                <Cpu className="text-[var(--accent)]" size={28} /> Agent Router & Qwen Pipeline
              </h2>
              <p className="text-[var(--text)]/80 text-lg leading-relaxed mb-10 font-medium">
                Every reply is generated by Qwen and streamed to the client token by token. The router's only job is to decide whether a request is a roadmap build — which is deterministic — and to ground the model in retrieved knowledge before it answers.
              </p>
              ...
              <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface-1)] overflow-hidden shadow-sm hover:shadow-lg transition-all">
                ...
                <div className="p-8 space-y-10">
                  <div id="smart-router-heuristics" className="scroll-mt-24 flex gap-6 items-start group">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">Roadmap Detection</h4>
                      <p className="text-[var(--muted)] font-medium">A service selection such as `Cafe & Restaurant - New Application in Kadıköy` is built directly by the protocol engine, so the Dashboard always receives the same machine-readable step structure. No model call, no tokens spent.</p>
                    </div>
                  </div>
                  <div id="smart-router-context" className="scroll-mt-24 flex gap-6 items-start group">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">Knowledge Retrieval</h4>
                      <p className="text-[var(--muted)] font-medium">The query is embedded with `text-embedding-v3` and matched against the knowledge base via pgvector cosine search. Any relevant passages are injected into the system prompt and cited in the reply.</p>
                    </div>
                  </div>
                  <div id="smart-router-caching" className="scroll-mt-24 flex gap-6 items-start group">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">Streaming Generation</h4>
                      <p className="text-[var(--muted)] font-medium">Qwen answers natively in English, Turkish or Arabic and streams back over SSE. It can call `start_roadmap` mid-conversation, which hands off to the protocol engine and opens the Dashboard.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section id="terms" className="scroll-mt-24 relative">
              ...
              <div className="space-y-16 text-[var(--text)]/80 leading-relaxed font-medium relative z-10">
                ...
                <div id="terms-ip" className="scroll-mt-24 p-8 rounded-3xl bg-[var(--surface-1)] border border-[var(--border)] shadow-sm hover:border-rose-500/30 hover:bg-rose-500/[0.02] transition-all group">
                  ...
                  <p className="text-[var(--muted)] text-sm leading-relaxed">
                    All agency content — including AI model logic, Smart Router, workflow schemas, UI design, and documentation — is the exclusive intellectual property of TurkGateway. You retain ownership of your personal data, uploaded documents, and exported roadmaps.
                  </p>
                </div>
            ...
            <section id="privacy" className="scroll-mt-24 relative">
              ...
              <div className="space-y-24 relative z-10">
                ...
                <div id="privacy-sharing" className="scroll-mt-24 group">
                  ...
                  <p className="text-[var(--muted)] leading-relaxed font-medium">
                    We do not sell your personal data. We only share anonymized analytical data with infrastructure providers to maintain uptime and performance.
                  </p>
                </div>
                ...
                <div id="privacy-updates" className="scroll-mt-24 group">
                  ...
                  <p className="text-[var(--muted)] leading-relaxed font-medium">
                    This policy may be updated to reflect changes in legal requirements or agency services. Users will be notified of significant changes via email or dashboard alerts.
                  </p>
                </div>
              </div>
