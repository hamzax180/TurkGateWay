            ...
            >
              ...
              <div className="relative z-10 text-[var(--text)]">
                <div className="flex items-center gap-4 mb-8">
                  <div className={`relative w-12 h-12 rounded-[16px] flex items-center justify-center transition-all duration-500 overflow-hidden shrink-0 border ${['University Enrollment', 'Kimlik Renewal'].includes(activeTask || '') ? 'bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-[0_0_25px_rgba(16,185,129,0.6)] border-emerald-400/40' :
