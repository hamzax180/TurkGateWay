...
export default function DownloadPage() {
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] selection:bg-[var(--primary)] selection:text-white flex flex-col font-sans">
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-[var(--muted)] max-w-2xl mx-auto mb-12">
              Experience the full power of TurkGateway directly from your Desktop. Faster responses, dedicated window, and seamless background operations for Windows, Mac, and Linux.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left border-t border-[var(--border)] pt-16">
              {/* Feature 1 */}
              <div className="group relative p-8 rounded-3xl bg-[var(--surface-1)] border border-[var(--border)] hover:border-blue-500/50 transition-all duration-500 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-blue-500/10">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] flex items-center justify-center text-blue-500 mb-6 group-hover:scale-110 group-hover:border-blue-500/30 transition-all duration-500">
                    <Monitor size={24} />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-[var(--text)]">Native Performance</h3>
                  <p className="text-sm text-[var(--muted)] leading-relaxed">Runs entirely outside the browser with dedicated system resources for radically faster AI inference and multitasking.</p>
                </div>
              </div>
              
              {/* Feature 2 */}
              <div className="group relative p-8 rounded-3xl bg-[var(--surface-1)] border border-[var(--border)] hover:border-emerald-500/50 transition-all duration-500 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-emerald-500/10">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] flex items-center justify-center text-emerald-500 mb-6 group-hover:scale-110 group-hover:border-emerald-500/30 transition-all duration-500">
                    <ShieldCheck size={24} />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-[var(--text)]">Local Processing</h3>
                  <p className="text-sm text-[var(--muted)] leading-relaxed">Includes the fully embedded local backend engine to keep your sensitive regulatory documents strictly offline.</p>
                </div>
              </div>

              {/* Feature 3 */}
              <div className="group relative p-8 rounded-3xl bg-[var(--surface-1)] border border-[var(--border)] hover:border-purple-500/50 transition-all duration-500 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-purple-500/10">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] flex items-center justify-center text-purple-500 mb-6 group-hover:scale-110 group-hover:border-purple-500/30 transition-all duration-500">
                    <CheckCircle size={24} />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-[var(--text)]">Auto-Updates</h3>
                  <p className="text-sm text-[var(--muted)] leading-relaxed">Always stay on the latest verified version with silent, non-intrusive background updates to avoid any downtime.</p>
                </div>
              </div>
            </div>
