    ...
    items: [
      {
        ...
        whereToGet: t(
          'We open e-ikamet.goc.gov.tr here and fill it with you — the portal e-mails a one-time link partway through, and it has to be opened in that same window',
          'e-ikamet.goc.gov.tr\'yi burada açıp sizinle doldururuz — portal ortada tek kullanımlık bir bağlantı e-postalar ve o bağlantı aynı pencerede açılmalıdır',
          'نفتح e-ikamet.goc.gov.tr هنا ونملأه معك — يرسل الموقع رابطاً لمرة واحدة في المنتصف، ويجب فتحه في النافذة نفسها',
          'e-ikamet.goc.gov.tr-ni şu ýerde açyp, siziň bilen doldurýarys — portal ortasynda bir gezeklik salgy iberýär, ol hem şol penjirede açylmaly',
        ),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        whereToGet: t('We open e-ikamet.goc.gov.tr here and fill it with you — apply before expiry, ideally 60 days ahead', 'e-ikamet.goc.gov.tr\'yi burada açıp sizinle doldururuz — bitişten önce, ideal olarak 60 gün önceden başvurun', 'نفتح e-ikamet.goc.gov.tr هنا ونملأه معك — قدّم قبل الانتهاء، ويفضل قبل 60 يوماً', 'e-ikamet.goc.gov.tr-ni şu ýerde açyp, siziň bilen doldurýarys — gutarmanka, ideal ýagdaýda 60 gün öň arza beriň'),
      },
      {
