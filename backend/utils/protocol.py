...
def _steps_student(lang):
    return [
        (1,  {"en":"Obtain University Acceptance","tr":"Üniversite Kabulü Al","ar":"الحصول على قبول جامعي"}[lang],
              ...
              {"en":["University Acceptance / Enrollment Letter","Valid Passport"],"tr":["Kabul / Kayıt Belgesi","Geçerli Pasaport"],"ar":["خطاب القبول الجامعي","جواز سفر ساري"]}[lang]),
        ...
        (3,  {"en":"University Office Enrollment","tr":"Üniversite Kaydını Tamamla","ar":"استكمال التسجيل الجامعي"}[lang],
              ...
              {"en":["Acceptance Letter","Passport","High School Diploma + Apostille","Transcript","Biometric Photos (2 pcs)","Tuition Payment Receipt"],"tr":["Kabul Mektubu","Pasaport","Lise Diploması + Apostil","Transkript","Biyometrik Fotoğraf (2 adet)","Harç Ödeme Makbuzu"],"ar":["خطاب القبول","جواز السفر","دبلوم الثانوية + أبوستيل","كشف العلامات","صور بيومترية (2)","إيصال سداد الرسوم"]}[lang]),
    ...
    return [
        (1,  {"en":"Identify Your Concern","tr":"Sorununuzu Belirleyin","ar":"تحديد المشكلة"}[lang],
              ...
              {"en":"Clearly note which clauses or terms feel unfair, unclear, or problematic. Write down your main concern before the consultation.",
               "tr":"Hangi maddelerin haksız, belirsiz veya sorunlu göründüğünü not edin. Ajanlık öncesinde ana sorununuzu yazın.",
